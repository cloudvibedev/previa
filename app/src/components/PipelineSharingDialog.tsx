...
export function PipelineSharingDialog({
  ...
  const [selectedAccessLevel, setSelectedAccessLevel] = useState<api.PipelineShareAccessLevel>("editor");
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <select
                  ...
                  disabled={saving}
                  onChange={(event) => setSelectedAccessLevel(event.target.value as api.PipelineShareAccessLevel)}
...
const SHARE_ACCESS_LEVELS: Array<{ value: api.PipelineShareAccessLevel; label: string }> = [
...
function shareAccessLabel(value: api.PipelineShareAccessLevel): string {
